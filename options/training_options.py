import argparse
from .testing_options import str2bool #定义bool型str
...
class TrainOptions():
    ...
    def initialize(self):
        ...
        parser.add_argument('--Filenum', help='num of file(8)', type=int, default=0)
        ...
        parser.add_argument('--Dataset', help='Dataset', type=str, default='arrhythmia_normalization')
        parser.add_argument('--ImgChnNum', help='image channel', type=int, default=1)
        parser.add_argument('--FeatureDim', help='feature_dim', type=int, default=279)
        parser.add_argument('--FrameNum', help='frame num for video clip', type=int, default=16)
        parser.add_argument('--BatchSize', help='training batchsize', type=int, default=1)
        parser.add_argument('--LR', help='learning rate', type=float, default=1e-4)
        parser.add_argument('--EpochNum', help='max epoch num', type=int, default=50)#30
        parser.add_argument('--MemDim', help='Memory Dimention', type=int, default=10)
        ...
        ##
        parser.add_argument('--TextLogInterval', help='text log ite interval', type=int, default=200)
