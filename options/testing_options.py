...
class TestOptions():
    ...
    def initialize(self):
        ...
        parser.add_argument('--ModelSetting',
                            help='feature/featureSpar',
                            type=str,
                            default='featureSpar')  # give the layer details later
        ...
        ##
        parser.add_argument('--ModelRoot', help='Path and name for trained model.', type=str, default='./models/model_')
        ...
        parser.add_argument('--Suffix1', help='Suffix1', type=str, default='_epoch_0049_final')
